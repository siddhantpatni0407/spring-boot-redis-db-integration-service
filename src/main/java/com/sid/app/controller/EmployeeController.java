 ...
 * <p>
 * Provides REST endpoints for creating, retrieving, updating, and deleting Employee records.
 * Uses EmployeeService for business logic and ApplicationUtils for JSON logging.
 * <p>
 * Endpoints:
 * - POST /employee: Create or update an employee
...
public class EmployeeController {
    ...
    public ResponseEntity<Employee> getEmployeeById(@PathVariable String id) {
        ...
        if (employee.isPresent()) {
            log.info("getEmployeeById() : Response -> {}", ApplicationUtils.getJSONString(employee.get()));
    ...
    public ResponseEntity<Employee> updateEmployee(@RequestBody Employee request, @PathVariable String id) {
