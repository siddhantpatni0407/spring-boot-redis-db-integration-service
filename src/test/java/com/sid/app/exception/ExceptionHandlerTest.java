...
class ExceptionHandlerTest {
    ...
    void testExceptionHandler_ReturnsErrorMessage() {
        ...
        assertEquals(expectedErrorMessage, response.get("errorMessage"), "Error message should match the exception message");
    }
    ...
    void testExceptionHandler_ResponseStatusAnnotation() throws NoSuchMethodException {
        // Act
        ResponseStatus responseStatus = exceptionHandler.getClass()
        ...
        assertEquals(HttpStatus.NOT_FOUND, responseStatus.value(), "HTTP status should be NOT_FOUND (404)");
    }
}
