...
class EmployeeControllerTest {
    ...
    @Autowired
    private EmployeeService employeeService; // Inject the mock from config
    ...
    void testCreateEmployee() throws Exception {
        ...
        mockMvc.perform(post(AppConstants.EMPLOYEE_ENDPOINT)
    ...
    void testGetEmployeeById_Found() throws Exception {
        ...
        mockMvc.perform(get(AppConstants.EMPLOYEE_ENDPOINT + "/101"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.id").value("101"))
                .andExpect(jsonPath("$.name").value("Siddhant"));
    }
    ...
    void testGetEmployeeById_NotFound() throws Exception {
        ...
        mockMvc.perform(get(AppConstants.EMPLOYEE_ENDPOINT + "/999"))
    ...
    void testGetAllEmployees() throws Exception {
        ...
        mockMvc.perform(get(AppConstants.EMPLOYEE_ENDPOINT))
                .andExpect(status().isOk())
    ...
    void testUpdateEmployee_Found() throws Exception {
        ...
        mockMvc.perform(put(AppConstants.EMPLOYEE_ENDPOINT + "/101")
                        .contentType(MediaType.APPLICATION_JSON)
    ...
    void testDeleteEmployee_Found() throws Exception {
        ...
        mockMvc.perform(delete(AppConstants.EMPLOYEE_ENDPOINT + "/101"))
                .andExpect(status().isOk())
    ...
    /**
     * ✅ Custom Test Configuration to provide mocked EmployeeService
